...
uint8_t LPS25HB_Initialise(I2C_HandleTypeDef *i2cHandle){
	...
	HAL_I2C_Mem_Read( i2cHandle, LPS25HB_ADDRESS, LPS25HB_WHO_AM_I, I2C_MEMADD_SIZE_8BIT, & chipID, 1, 1000);
...
float LPS25HB_Measure_Temperature(I2C_HandleTypeDef *i2cHandle) {
  ...
  if (HAL_I2C_Mem_Write( i2cHandle, LPS25HB_ADDRESS, LPS25HB_CTRL_REG2, I2C_MEMADD_SIZE_8BIT, &datatowrite, 1, 100) != HAL_OK) {
    ...
    HAL_I2C_Mem_Read( i2cHandle, LPS25HB_ADDRESS, LPS25HB_TEMP_OUT_L, I2C_MEMADD_SIZE_8BIT, &TEMP_OUT_L, 1, 100);
    HAL_I2C_Mem_Read( i2cHandle, LPS25HB_ADDRESS, LPS25HB_TEMP_OUT_H, I2C_MEMADD_SIZE_8BIT, &TEMP_OUT_H, 1, 100);
